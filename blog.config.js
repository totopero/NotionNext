...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'tottocone', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'ととペロ', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://toto2pero.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'tottocone', // 网站关键词 英文逗号隔开
